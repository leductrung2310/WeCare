  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        BannerWorkouts(
          tag: "arm_begin",
          srcImage: 'assets/images/exercises/banner/male/legs_beginner.png',
          press: () {
        ...
        BannerWorkouts(
          ...
          srcImage: 'assets/images/exercises/banner/male/legs_intermediate.png',
          press: () {
            final args = ExerciseArguments(
                tag: "arm_intermediate",
                banner: "assets/images/exercises/intro/arm_begin.png",
        ...
        BannerWorkouts(
          tag: "arm_advanced",
          srcImage: 'assets/images/exercises/banner/male/legs_advanced.png',
          press: () {
            final args = ExerciseArguments(
                tag: "arm_advanced",
                banner: "assets/images/exercises/intro/arm_begin.png",
